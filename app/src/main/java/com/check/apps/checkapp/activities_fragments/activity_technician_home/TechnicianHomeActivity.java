package com.check.apps.checkapp.activities_fragments.activity_technician_home;
...
import com.check.apps.checkapp.databinding.ActivityTechnicianHomeBinding;
...
public class TechnicianHomeActivity extends AppCompatActivity {
    private ActivityTechnicianHomeBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_technician_home);
        initView();
    }
    ...
    private void initView() {
        ...
        binding.cardViewOrder.setOnClickListener(view -> {
            Intent intent = new Intent(this, TechnicianOrdersActivity.class);
            startActivity(intent);
        });
